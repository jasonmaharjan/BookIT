 	...
 	render() {
        ...
        <View style={styles.container}>
                  ...
                  <View style={styles.mainConatiner}>
                      ...
                      <TouchableHighlight style={[styles.buttonContainer, styles.requestBookButton]} onPress={() => this.onRequestbookPressed('request_books')}>
                          <Text style={styles.requestBookText}>Request Book</Text>
                      </TouchableHighlight>           
                </View>
        </View>	
      </ScrollView>
